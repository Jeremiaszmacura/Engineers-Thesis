...
/**
* @swagger
* /exams/show-responses/:uuid':
*  get:
*    description: Pass Exam's uuid to get responses to it
*    responses:
*      '200':
*        description: A successful response
*/
router.get("/show-responses/:uuid", examsController.examShowResponsesGet);


/**
* @swagger
* /exams/general-report/:uuid':
*  get:
*    description: Pass Exam's uuid to get general report of this exam
*    responses:
*      '200':
*        description: A successful response
*/
router.get("/general-report/:uuid", examsController.examGeneralReportGet);
